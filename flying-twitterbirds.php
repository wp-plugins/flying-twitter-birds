...
Plugin URI: http://www.miscellaneousvalley.org/
...
Author URI: http://www.theandroid-mania.com/author/admin/
License: GPLv2
*/
...
function flying_twitter() {
 add_menu_page('Flying Twitter', 'Flying Twitter', 'manage_options', 'flying-twitter', 'flying_twitter_config',plugins_url('flying-twitterbirds/images/twitter-ico.png') ); 
}
function flying_twitter_config()
{
    ...
    <td>
		...
		<td>
        <input <?php echo (get_option("twt_js")=='js/twitterbird-holi.js')?'checked="checked"':'';?> name="twt_js" type="radio" value="js/twitterbird-holi.js"/></td>
        <td><img class="middle" src="<?php echo plugins_url( 'images/twitterbird-holi-thimb.png' , __FILE__ );?>"/></td>
        </tr>
        </tbody>
        </table>
    </td>
...
{
	add_option("twt_user","miscvalley");
	add_option("twt_text","Read @ PHP Scripts, WordPress Plugins,| Miscellaneous Valley http://www.miscellaneousvalley.org/");
	add_option("twt_js","js/twitterbird.js");
	add_option( "ftwitter_db_version", "1.5" );
}
